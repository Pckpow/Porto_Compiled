            ...
            <div className="h-3/6 rounded-2xl bg-gradient-to-t from-orange-500 to-orange-600 px-16 py-14 shadow-2xl md:filter-none">
              ...
              <form>
                <div className="text-1xl py-4">
                  <h2 class="py-2 text-left text-xl font-bold">Nama</h2>
                  <input
                ...
                <div className="mb-4">
                  <h2 class="py-2 text-left text-xl font-bold">
                    Confirm Password
                  </h2>
                  <input
                    className="w-full rounded-2xl py-2 px-5 shadow-md"
              ...
              <div class="flex justify-start">
                <label class=" block flex items-center">
                  <input
                    ...
                    type="checkbox"
                  />
                  <span class="text-regular ml-2">
                    Saya setuju dengan Terms and Conditions dan information data
                    policy website ini.
                  </span>
                </label>
              </div>
              ...
              <div class="mt-7 cursor-pointer font-semibold  hover:underline">
                <Link href="/login">Punya akun? Klik disini!</Link>
              </div>
            </div>
          </div>
          <div></div>
